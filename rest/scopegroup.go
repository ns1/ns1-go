...
func (s *ScopeGroupService) List(ctx context.Context) ([]dhcp.ScopeGroup, *http.Response, error) {
	req, err := s.client.NewRequest(ctx, http.MethodGet, "dhcp/scopegroup", nil)
	if err != nil {
		return nil, nil, err
	}
...
func (s *ScopeGroupService) Get(ctx context.Context, sgID int) (*dhcp.ScopeGroup, *http.Response, error) {
...
func (s *ScopeGroupService) Create(ctx context.Context, sg *dhcp.ScopeGroup) (*dhcp.ScopeGroup, *http.Response, error) {
	switch {
	case sg.Name == "":
		return nil, nil, errors.New("the Name field is required")
	}

	req, err := s.client.NewRequest(ctx, http.MethodPut, "dhcp/scopegroup", sg)
	if err != nil {
		return nil, nil, err
	}
...
func (s *ScopeGroupService) Edit(ctx context.Context, sg *dhcp.ScopeGroup) (*dhcp.ScopeGroup, *http.Response, error) {
	if sg.ID == nil {
		return nil, nil, errors.New("the ID field is required")
	}

	reqPath := fmt.Sprintf("dhcp/scopegroup/%d", *sg.ID)
	req, err := s.client.NewRequest(ctx, http.MethodPost, reqPath, sg)
	if err != nil {
		return nil, nil, err
	}
...
func (s *ScopeGroupService) Delete(ctx context.Context, id int) (*http.Response, error) {
