...
func (s *DataFeedsService) List(dsID string) ([]*data.Feed, *http.Response, error) {
...
func (s *DataFeedsService) Get(dsID string, dfID string) (*data.Feed, *http.Response, error) {
...
func (s *DataFeedsService) Create(df *data.Feed) (*http.Response, error) {
...
func (s *DataFeedsService) Update(df *data.Feed) (*http.Response, error) {
...
func (s *DataFeedsService) Delete(dsID string, dfID string) (*http.Response, error) {
	path := fmt.Sprintf("data/feeds/%s/%s", dsID, dfID)
